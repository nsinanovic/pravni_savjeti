...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { email: @employer.email, location: @employer.location, name: @employer.name, password: @employer.password, username: @employer.username, website: @employer.website }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { email: @employer.email, location: @employer.location, name: @employer.name, password: @employer.password, username: @employer.username, website: @employer.website }
    assert_redirected_to employer_path(assigns(:employer))
  end
